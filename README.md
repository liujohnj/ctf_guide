...
* Most CTFs have a Discord or Slack channel you can join.  It's not necessarily helpful with finding solutions directly, but sometimes they will post something timely on there about there being a problem with one of the challenges that they are working to resolve, or that they just released a hint for a challenge.  After the event, I have seen folks freely discuss solutions there, or even on an Internet Relay Chat (IRC) board.
